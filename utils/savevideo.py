...
def SaveRunVideo(cap = None, frame_gather = [], logger = logging.Logger) -> None:
    # print('Saving Run Video Now:',len(frame_gather))
    logger.info(f"Saving Run Video Now:{len(frame_gather)}")
    if cap != None:
